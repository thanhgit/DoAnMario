...
public class SceneManager {
	    ...
	    {
	    	ResourcesManager.getInstance().loadTutorialScreen();
	        tutorialScene = new TutorialScene();
	        SceneManager.getInstance().setScene(tutorialScene);
	    }
	    
	    private void disposeTutorialScene()
	    {
	    	ResourcesManager.getInstance().unloadTutorialScreen();
	    ...
	    public void loadMenuSceneFromTutorial(final Engine mEngine)
	    {
	    	tutorialScene.disposeScene();
	    	ResourcesManager.getInstance().unloadTutorialScreen();
	    	setScene(menuScene);
